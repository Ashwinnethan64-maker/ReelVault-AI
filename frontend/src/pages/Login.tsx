  ...
  return (
    <div className="min-h-screen w-full flex bg-background">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-zinc-950 flex-col justify-between p-12 overflow-hidden border-r border-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-indigo-900/40 via-zinc-950 to-zinc-950"></div>
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            <h1 className="text-4xl font-bold text-white mb-6 leading-tight">
              Your ultimate <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">knowledge vault</span> for video content.
            </h1>
            <p className="text-zinc-400 text-lg leading-relaxed">
              Save, search, and extract actionable insights from any Instagram reel instantly with AI.
            </p>
          </motion.div>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-zinc-900/50 border-white/10 focus:border-indigo-500/50 transition-colors"
                  required
                />
              </div>
            </div>
